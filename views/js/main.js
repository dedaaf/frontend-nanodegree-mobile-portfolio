  ...
  function changePizzaSizes(size) {
    ...
    function getDomNodeArray(selector) {
      // get the elements as a DOM collection
        ...
        var elemArray = Array.prototype.slice.apply(pizzaContainer);
    ...
    dx = determineDx(container,size);
    newwidth = (container.offsetWidth + dx) + 'px';
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var spaceBetween = 256;

  var windowWidth = window.innerWidth;     console.log('windowWidth', windowWidth); //get window width
  var windowHeight = window.innerHeight;   console.log('windowHeight',windowHeight); //get window Heigth

  var amountPizzaColumn = Math.round(windowWidth / 240) ;console.log('amountPizzaColumn', amountPizzaColumn);//calculate the amount of pizzas in a column
  var amountPizzaRow = Math.round(windowHeight / 240); console.log('amountPizzaRow', amountPizzaRow); //calculate the amount of rows available for pizzas
  var amountPizzas = amountPizzaRow * amountPizzaColumn; console.log('amountPizzas', amountPizzas);//the total amount of pizzas for the screen
  var elem; //the pizza element outside the for loop, better for memory.
    ...
    for (var i = 0; i < amountPizzas; i++) {
      ...
      elem.basicLeft = (i % amountPizzaColumn) * spaceBetween; console.log('elem.basicLeft.'+i,elem.basicLeft);
      elem.style.top = (Math.floor(i / amountPizzaColumn) * spaceBetween) + 'px';
